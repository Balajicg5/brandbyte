...
export default function Footer() {
  ...
  const logoSrc = mounted && resolvedTheme === "dark" ? "/brandbyte-logo-light.png" : "/brandbyte-logo-dark.png"
    ...
    <footer className="container py-8 border-t border-gray-200 dark:border-gray-800">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 max-w-md mx-auto mb-8">
          BrandByte: Effortless AI-Powered Ad Creative Generation.
        </p>

        <p className="text-sm text-gray-500 dark:text-gray-400">
          © {new Date().getFullYear()} BrandByte. All rights reserved.
        </p>
      </div>
    </footer>
  )
